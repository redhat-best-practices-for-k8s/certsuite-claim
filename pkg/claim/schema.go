...
//
// Code generated by `test-network-function-claim/cmd/generate/generate.go` on: 2022-08-05 10:30:48.907706 -0500 CDT m=+0.002255229
//
...
type Identifier struct {
  ...
  // tags stores the scenarios the for the test.
