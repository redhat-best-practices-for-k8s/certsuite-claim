...
//
// Code generated by `certsuite-claim/cmd/generate/generate.go` on: 2024-07-26 10:31:19.664412 -0500 CDT m=+0.001070334
//
...
type Metadata struct {
  ...
  // The UTC start time of a claim evaluation.  This is recorded when the redhat-best-practices-for-k8s test suite is invoked.
...
func (strct *Result) UnmarshalJSON(b []byte) error {
    ...
    for k, v := range jsonMap {
        ...
        case "checkDetails":
            if err := json.Unmarshal([]byte(v), &strct.CheckDetails); err != nil {
                return err
             }
            checkDetailsReceived = true
        case "duration":
        ...
        case "skipReason":
            if err := json.Unmarshal([]byte(v), &strct.SkipReason); err != nil {
                return err
             }
            skipReasonReceived = true
        case "startTime":
            if err := json.Unmarshal([]byte(v), &strct.StartTime); err != nil {
                return err
             }
    ...
    // check if checkDetails (a required property) was received
    if !checkDetailsReceived {
        return errors.New("\"checkDetails\" is required but was not present")
    }
    ...
    // check if skipReason (a required property) was received
    if !skipReasonReceived {
        return errors.New("\"skipReason\" is required but was not present")
    }
    // check if startTime (a required property) was received
    if !startTimeReceived {
        return errors.New("\"startTime\" is required but was not present")
